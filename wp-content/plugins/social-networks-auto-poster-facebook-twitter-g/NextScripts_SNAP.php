...
*/
define( 'NextScripts_SNAP_Version' , '3.7.16' ); 
...
require_once "nxs_functions.php"; require_once "inc/nxs_functions_wp.php"; require_once "inc/nxs-http.php"; require_once "inc/nxs_functions_adv.php"; 
