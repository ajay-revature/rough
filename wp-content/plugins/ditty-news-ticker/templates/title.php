...
if( isset($_mtphr_dnt_title) && $_mtphr_dnt_title ) {
	...
	echo '<h3 class="mtphr-dnt-title'.$inline_title.'"><i class="fa fa-caret-right news-right-triangle" aria-hidden="true"></i>'.apply_filters( 'mtphr_dnt_ticker_title', get_the_title($_mtphr_dnt_id) ).'</h3>';
