...
class Yoast_GA_Admin_Menu {
	...
	public function create_admin_menu() {
		...
		// Add main page
		add_menu_page(
			__( 'Google Analytics by MonsterInsights:', 'google-analytics-for-wordpress' ) . ' ' . __( 'General settings', 'google-analytics-for-wordpress' ), __( 'Insights', 'google-analytics-for-wordpress' ), 'edit_pages', 'yst_ga_' . $menu_name,
			array(
				$this->target_object,
				'load_page',
			),
