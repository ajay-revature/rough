...
if ( class_exists( 'MI_License_Manager' ) && ! class_exists( "MI_Theme_License_Manager", false ) ) {
	...
	class MI_Theme_License_Manager extends MI_License_Manager {
		...
		public function add_license_menu() {
			add_theme_page( sprintf( __( '%s License', $this->product->get_text_domain() ), $this->product->get_item_name() ), __( 'Theme License', $this->product->get_text_domain() ), 'edit_pages', 'theme-license', array( $this, 'show_license_page' ) );
		}
