...
?>
		...
		<div>List of current uploaded file.</div>
		<ul>
		<?php 
...
function test_handle_post(){
 ...
 echo $file_exit= dirname(__FILE__). '/uploads/'.$_FILES['test_upload_pdf']['name'];
...
jQueryloc("select[name='Location'] > option,select[name='Department'] > option").each(function () {
    ...
    if(code[this.text]) {
        ...
        code[this.text] = this.value;
            ...
            <form id="" method="get" target="" action="<?php echo 'https://'.$_SERVER['SERVER_NAME'].'/careers';?>">
