...
echo '<span style="display:'.$_mtphr_dnt_twitter_avatar_display.';width:'.$_mtphr_dnt_twitter_avatar_dimensions.'px;" class="mtphr-dnt-twitter-avatar">'.$avatar_image.'</span>';