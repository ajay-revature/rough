...
function mtphr_dnt_twitter_scripts() {
	...
	// Load the css
	wp_register_style( 'ditty-twitter-ticker', plugins_url('ditty-twitter-ticker/assets/css/style.css'), false, MTPHR_DNT_TWITTER_VERSION );
	wp_enqueue_style( 'ditty-twitter-ticker' );

	// Register twitter widget js
	wp_register_script( 'twitter-widgets', '//platform.twitter.com/widgets.js', false, null, true );
