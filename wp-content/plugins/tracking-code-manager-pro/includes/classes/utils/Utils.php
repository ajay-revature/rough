...
class TCMP_Utils {
                ...
                if ($q) {
                    ...
                    foreach($wp_taxonomies as $k=>$v) {
                        ...
                        if($isPublic && $k!='post_format') {
                            $name=$tcmp->Utils->get($v, 'labels.singular_name');
                            if($options['type']!='') {
                                $types=$tcmp->Utils->get($v, 'object_type');
                                $types=$tcmp->Utils->toArray($types);
    ...
    function isAdminUser() {
        ...
        return (is_multisite() || current_user_can('edit_pages'));
        */
    }
