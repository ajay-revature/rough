...
<div class="col-lg-4 col-md-4 col-sm-4 code_life_faq_section">  
  ...
  <div class="form-group">
   <input type="text" class="shortfield-home form-control height_search" placeholder="Enter your question"id="search">
  </div>
   ...
   <div class='col-sm-4 col-md-4 col-lg-4'>
         <div class='Revature_student_reviews_content'>             
           ...
           <div class='col-sm-7 col-md-7 col-lg-7' style='padding-top: 12px;'>
              <div>
               <a class='fancybox fancybox.iframe' href='".$a['reviewer_video']."'><img style='display: initial !important;' class='img-responsive' src='". wp_get_attachment_url($a["video_thumbnail"]) ."'  draggable='false'></a>
          </div>
           </div>
    </div>
           </section>";
...
.compose-mode .vc_element, .view-mode .vc_element {
	...
	<div class='revature-video-slider-section vc_empty-element'>
		<div class='container'>
...
array(
"type"=>"attach_image",
"heading"=>__("Training Process: Background Image", "revature"),
"param_name"=>"background_img",
"description"=>__("Training Process: Background Image", "revature
")
),
array(
"type"=>"textfield",
...
array(
"type"=>"attach_image",
"heading"=>__("Blue Locations: Location Image1", "revature"),
"param_name"=>"location_img1",
"description"=>__("Blue Locations: Location Image1", "revature")
),
array(
"type"=>"textfield",
...
array(
"type"=>"attach_images",
"heading"=>__("Blue Locations: DC Slider Images", "revature"),
"param_name"=>"dc_img1",
"description"=>__("Blue Locations: DC Slider Images", "revature")
),
array(
"type"=>"attach_image",
"heading"=>__("Blue Locations: Location Image2", "revature"),
"param_name"=>"location_img2",
"description"=>__("Blue Locations: Location Image2", "revature")
),
array(
"type"=>"textfield",
"heading"=>__("Blue Locations: Id", "revature"),
...
array(
"type"=>"attach_images",
"heading"=>__("Blue Locations: FL Slider Images", "revature"),
"param_name"=>"fl_img1",
"description"=>__("Blue Locations: FL Slider Images", "revature")
),
array(
"type"=>"attach_image",
"heading"=>__("Blue Locations: Location Image3", "revature"),
"param_name"=>"location_img3",
"description"=>__("Blue Locations: Location Image3", "revature")
),
array(
"type"=>"textfield",
"heading"=>__("Blue Locations: Id", "revature"),
...
array(
"type"=>"attach_images",
"heading"=>__("Blue Locations: NYC Slider Images", "revature"),
"param_name"=>"nyc_img1",
"description"=>__("Blue Locations: NYC Slider Images", "revature")
),
)
));
    vc_map(array(
