...
$returnHTML="
    ...
    <div>
      <img style='height:180px; width:180px;'src='". wp_get_attachment_image_src($a['thumbnail_image1'], 'full')[0] ."' />
    </div>
    <div>
      <img style='height:180px; width:220px;' src='". wp_get_attachment_image_src($a['thumbnail_image2'], 'full')[0] ."' />
    </div>
    <div>
      <img style='height:180px; width:220px;'src='". wp_get_attachment_image_src($a['thumbnail_image3'], 'full')[0] ."' />
    </div>
    <div>
      <img style='height:180px; width:220px;'src='". wp_get_attachment_image_src($a['thumbnail_image4'], 'full')[0] ."' />
    </div>
    <div>
      <img style='height:180px; width:220px;'src='". wp_get_attachment_image_src($a['thumbnail_image5'], 'full')[0] ."' />
    </div>
