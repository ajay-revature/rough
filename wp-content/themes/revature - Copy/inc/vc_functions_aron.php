<?php	/**
	...
	--Start----- slider Client Academic Partners--------------------
...
$returnHTML="
    ...
    <div>
      <img style='height:auto; width:180px;'src='". wp_get_attachment_image_src($a['thumbnail_image1'], 'full')[0] ."' />
    </div>
    <div>
      <img style='height:auto; width:220px;' src='". wp_get_attachment_image_src($a['thumbnail_image2'], 'full')[0] ."' />
    </div>
    <div>
      <img style='height:auto; width:220px;'src='". wp_get_attachment_image_src($a['thumbnail_image3'], 'full')[0] ."' />
    </div>
    <div>
      <img style='height:auto; width:220px;'src='". wp_get_attachment_image_src($a['thumbnail_image4'], 'full')[0] ."' />
    </div>
    <div>
      <img style='height:auto; width:220px;'src='". wp_get_attachment_image_src($a['thumbnail_image5'], 'full')[0] ."' />
    </div>
		...
		return '<section style="height: auto !important; "class="rev-online-today" id="apply">
					...
					<div class="mob-container-unset" id="bootcampFormContainer">
						<div class="row no-margin">
						  ...
						  <a class="Orange-read-btn margin-top-25 margin-right-15 fancybox-marketo" href="#inline">APPLY NOW<i class="fa fa-angle-right" aria-hidden="true"></i></a>
					 </div>
				 </div>
			</section>';
	}
