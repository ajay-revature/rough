...
'logo_img'   => 'logo_img',
'logo_id'=>'Logo Id',
'sample_fancybox_img'=>'Sample Fancybox Image'
), $atts);
$returnHTML = '<style>
...
<a href="#inline'.$a['logo_id'].'" class="fancybox white-read-btn button_setting">'.$a['button_text'].'<i class="fa fa-angle-right"></i></a>
...
<div id="inline'.$a['logo_id'].'" class="principle-quick-content" style="display:none;">
 <img src="'.wp_get_attachment_url($a['sample_fancybox_img']).'" />
...
function training_curriculum_spotlight_func($atts, $content=null){
    ...
    $returnHTML = '
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 no-padding">    
				...
				<a class="fancybox" href="#inline'.$a['person_id'].'"><img style="display: initial !important;" class="img-responsive" src="'.wp_get_attachment_url($a['image']).'"> </a>
                <div class="spotlight_position">
                <div class="training_curriculum_spotlight_section" style="background-color:'.$a['color'].'">      
                <h3 class="spotlight_header"><a class="fancybox" href="#inline'.$a['person_id'].'">'. $a['header'] .'</a></h3>
                <p class="spotlight_subheader"><a class="fancybox" href="#inline'.$a['person_id'].'">'.$a['link_txt'].'</a></p>
                </div>                
               </div>
			   <div id="inline'.$a['person_id'].'" class="principle-quick-content" style="display:none;">
         
            <div class="img_left_side"><img width="161" class="about-img-responsive img-left" src="'.wp_get_attachment_image_src($a['image'], 'full')[0].'" alt=""></div>
            <div class="img_left_side"> <h2 class="leadership-desc-header">'.$a['header'].'</h2>
            <p class="leadership-desc-content">'.$content.'</p></div>
...
<div id="'.$a[location_id1].'">
  ...
  <div id="myCarousel1"  class="carousel slide" data-ride="carousel" data-wrap="true">
    ...
    <div class="carousel-inner">
      <div class="item active">                     
        <img class="img-responsive" src="' . wp_get_attachment_url($a['dc_img1']) .'">
      </div>
      <div class="item">
        <img class="img-responsive" src="' . wp_get_attachment_url($a['dc_img2']) .'">
      </div>
    
    <div class="item">
        <img class="img-responsive" src="' . wp_get_attachment_url($a['dc_img3']) .'">
      </div>
      
      <div class="item">
        <img class="img-responsive" src="' . wp_get_attachment_url($a['dc_img4']) .'">
      </div>
      
      <div class="item">
        <img class="img-responsive" src="' . wp_get_attachment_url($a['dc_img5']) .'">
      </div>
...
<div id="'.$a[location_id2].'">  
  ...
  <div id="myCarousel2" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img class="img-responsive" src="' . wp_get_attachment_url($a['fl_img1']) .'">
      </div>
      <div class="item">
         <img class="img-responsive" src="' . wp_get_attachment_url($a['fl_img2']) .'">
      </div>
    
    <div class="item">
       <img class="img-responsive" src="' . wp_get_attachment_url($a['fl_img3']) .'">
      </div>
      
      <div class="item">
       <img class="img-responsive" src="' . wp_get_attachment_url($a['fl_img4']) .'">
      </div>
      
      <div class="item">
         <img class="img-responsive" src="' . wp_get_attachment_url($a['fl_img5']) .'">
      </div>
...
<div id="'.$a[location_id3].'">
  ...
  <div id="myCarousel3" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
         <img class="img-responsive" src="' . wp_get_attachment_url($a['nyc_img1']) .'">
      </div>
      <div class="item">
         <img class="img-responsive" src="' . wp_get_attachment_url($a['nyc_img2']) .'">
      </div>
    
    <div class="item">
         <img class="img-responsive" src="' . wp_get_attachment_url($a['nyc_img3']) .'">
      </div>
      
      <div class="item">
       <img class="img-responsive" src="' . wp_get_attachment_url($a['nyc_img4']) .'">
      </div>
      
      <div class="item">
        <img class="img-responsive" src="' . wp_get_attachment_url($a['nyc_img5']) .'">
      </div>
...
function training_social_media_section_func($atts, $content=null){
    $a=shortcode_atts(array(
        ...
        'link_txt'=>'Link Text',
			...
			$ab= do_shortcode('[instagram-feed num=12 cols=3 ]');
    $returnHTML = '<div class="col-lg-4 col-md-4 col-sm-4 no-padding instagram_feed_clear ">    
                '.$ab.'       
                </div>';
               return $returnHTML;
}
...
$a=shortcode_atts(array(
			...
			'logo_img_7' => 'Logo Img7',
			'logo_title_7' => 'Logo Title7',
            'logo_subtitle_7' => 'Logo SubTitle_7',
), $atts);
$returnHTML = '
<div class="col-lg-8 col-md-8 col-sm-8 no-padding"><section class="hwd-bgg"> 
            ...
            <p>'.$a['sub_title'].'</p>
                ...
                <div class="col-lg-6 col-md-8 col-sm-11  col-xs-12 position_round_text_section_first align-right-section section-1">
                ...
                <div class="clear"></div>
                                  <div style="float:right;"class="col-lg-6 col-md-6 col-sm-11 col-xs-12 align-right-section section-2 position_round_text_section_second">
                                  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 no-padding">
                    <span class="no-padding">
                ...
                <div class="clear"></div>
                                  ...
                                  <div style="float:right;"class="col-lg-6 col-md-6 col-sm-8 col-xs-12 align-right-section section-3 position_round_text_section_third ">
                ...
                <div class="clear"></div>
                <div style="float:right;"class="col-lg-6 col-md-6 col-sm-7 col-xs-12 position_round_text_section_fourth align-right-section section-4">
                ...
                <div class="col-lg-6 col-md-6 col-sm-9 col-xs-12 position_round_text_section_fifth align-right-section section-5">
                  ...
                  <div class="clear"></div>
                  <div class="col-lg-6 col-md-6 col-sm-11  col-xs-12 align-right-section position_round_text_section_sixth section-6">
                  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 no-padding">
                    <span class="no-padding">
				  ...
				  <div class="clear"></div>
                <div style="float:right;"class="col-lg-6 col-md-6 col-sm-8 col-xs-12 position_round_text_section_seventh align-right-section section-7">
                   
                    <div class="col-lg-2 col-md-2 col-sm-2 no-padding">
                     <span class="">
                        <img class="img-responsive" src="' . wp_get_attachment_url($a['logo_img_7']) .'" />
                    </span>
                    </div>
                    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 no-padding">
                    <h3 class="round_section_text_size">'.$a[logo_title_7].'</h3>
                    <span>'.$a[logo_subtitle_7].'</span>
                </div>
                </div>
            </div>
    </section>
	<section class="mobile_hwd-bgg" id="howItWorks">
			...
			<p class="mobile_subtitle_software">'.$a['sub_title'].'</p>
				...
				<div class="clear"></div>
				  ...
				  <div style="text-align:center;" class="col-xs-12 no-padding">
                    <span class="no-padding">
                        <img style="display: initial !important;" class="img-responsive" src="' . wp_get_attachment_url($a['logo_img_7']) .'" />
                    </span>
					</div>
					<div class="col-xs-12 no-padding mobile_round_section_span">
					<h3 class="mobile_round_section_text_size">'.$a[logo_title_7].'</h3>
                    <span>'.$a[logo_subtitle_7].'</span>
                </div>
				</div>
              </div>
...
<div class="col-lg-4 col-md-4 col-sm-4 code_life_faq_section">  
       <div>
            <div class = "code_life_faq_section_header">
              ...
              <form action="'.home_url( '/' ).'" method="get" target="_blank">
  <div class="form-group">
   <input type="text" class="shortfield-home form-control height_search" placeholder="Enter your question" id="tags" name="s" required/>
     <input type="hidden" value="rev_faq" name="post_type" />
  </div>
  <div style="text-align:left;margin-top:17px;" class="col-lg-12 col-xs-12 form-group">
  <button style="outline: 0px;" type="submit" class="grey-submit-btn">SEARCH<i class="fa fa-angle-right"></i></button>
  </div>
</form>
</div>               
</div>
...
return'<section style="height: auto !important;" class="university-custom-header" id="apply">
		<div class="row no-margin vertical-align-row">
	...
	<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="col-lg-4 col-lg-offset-1 col-md-5 col-md-offset-0 col-sm-4 col-sm-offset-1 university-logo">
      <img src="'. wp_get_attachment_image_src($a['university_logo'], "full")[0] .'" />
						</div>
					 </div>
				 </div>
			</section>';
...
function academic_university_left_side_area_func($atts, $content=null){
	...
	<div class="col-lg-8 col-md-8 col-sm-8  col-xs-12 academic-text-section">
...
function witny_landing_header_func($atts, $content=null){
        ...
        <div class="row no-margin contact-hero-content">
            ...
            <h1 style="color: '.$a['color'].'">'.$a['title'].'</h1>
                </div>
                </div>
                 <div class="row mrg_50">
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                 <span class="witny_sub_heading" style="color: '.$a['color'].'">'.$a['sub_title'].'</span>
                 </div>
                 <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                  <a href="#inline" class="orange-submit-btn fancybox-marketo">'.$a['btn_txt'].'<i class="fa fa-angle-right"></i></a>
                
            </div>
			<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 witny-logo">
				<img class="margin-right-15" src="'.wp_get_attachment_url($a['logo_1']).'">
				<img src="'.wp_get_attachment_url($a['logo_2']).'">
			</div>
        </div></div>
 </div>';
...
/*============================== Revature.in Pathways Shortcodes=================================*/

function pathways_top_func($atts, $content=null){
	$a=shortcode_atts(array(
		'main_title'=>'Main Title',
		'main_content'=>'Default Title',
		'left_img_1' => 'Image URL',
     ...
     <div class="container no-padding">
         <div class="row">
               <div class="col-lg-12 col-md-12 col-sm-12 margin-bottom-100">
                ...
                <a target="_blank" class="Orange-read-btn margin-top-25" href="http://showcase.revature.com">PROJECT SHOWCASE</a>
               </div>
              <div class="col-lg-6 col-md-6 col-sm-12 overflow-hidden height-320 no-padding">
                  <div class="">
                      <img class="business-img left" src="'. wp_get_attachment_image_src($a['left_img_1'], 'full')[0] .'">
             ...
             <div class="col-lg-6 col-md-6 col-sm-12 overflow-hidden height-320 no-padding">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 text-left padding-25 height-320">
                 <div class="RevPro-Bootcamp-container right">
                     <h4 class="RevPro-Online-head">'.$a['right_title_3'].'</h4>
                      <p class="RevPro-Online-content">
                    '.$a['right_content_3'].'
              ...
              <ul>
<li><strong>Level 100 - Basic:</strong> Understand the basics of programming and get familiar with fundamental project development activities</li>
<li><strong>Level 200 - Intermediate:</strong> Work with an emerging technology stack and learn to integrate n-Tier architecture in your project</li>
<li><strong>Level 300 - Enterprise:</strong> Work on real-time infrastructure of development and deployment including the use of tools like GitHub, SonarQube, Jenkins etc.</li>
<p>
                  </p>
...
add_shortcode('pathways_top', 'pathways_top_func');

function pathways_bottom_func($atts, $content=null){
	$a=shortcode_atts(array(
	   'main_title'=>'Default Title',
	   'main_content'=>'Default Title',
		'title_1'=>'Default Title',
	...
	'<section class="principle-pro-quick" id="mission">
         ...
         <div class="row no-margin">
               <div class="col-lg-12 col-md-12 col-sm-12 principle-quick-1 margin-top-70">
                <h3>'.$a['main_title'].'</h3>
				<p class="principle-quick-content-sub">'.$a['main_content'].'</p>
				<a class="Orange-read-btn margin-top-10" href="https://revature.in/signup/">SIGNUP TODAY</a>
               </div>
         </div>
         </div>
    <div class="principle-pro-quick-contain">
...
add_shortcode('pathways_bottom', 'pathways_bottom_func');



/*============================== End Revature.in Pathways Shortcodes=================================*/
...
function shortcode_integrationWithVC_Ajay(){
	...
	vc_map(array(
		...
		"name"=>__("Pathways - Top Section", "revature"),
		"base"=>"pathways_top",
		"content_element"=>true,
		"category"=>__("Revature Shortcodes", "revature"),
		"show_settings_on_create"=>true,
...
vc_map(array(
	...
	vc_map(array(
		...
		vc_map(array(
		"name"=>__("Pathways - Bottom Section", "revature"),
		"base"=>"pathways_bottom",
		"content_element"=>true,
		"category"=>__("Revature Shortcodes", "revature"),
		"show_settings_on_create"=>true,
		"params"=>array(
...
vc_map(array(
	...
	vc_map(array(       
        ...
        "params" => array(     
			...
			array(
				"type"=>"colorpicker",
				"heading"=>__("Color for Text", "revature"),
				"param_name"=>"color",
				"description"=>__("Color for Header and Sub-header", "revature")
			),
            array(
                "type"=>"attach_image",
			...
			array(
                ...
                "param_name"=>"logo_1",
                "description"=>__("Top Logo", "revature")
            ),
			array(
                "type"=>"attach_image",
                "heading"=>__("Logo 2", "revature"),
                "param_name"=>"logo_2",
                "description"=>__("Bottom Logo", "revature")
            )
        )       
    ));
...
array(
"type"=>"attach_image",
"heading"=>__("Training Process: Icon Image7", "revature"),
"param_name"=>"logo_img_7",
"description"=>__("Training Process: Icon Image7", "revature")
),
array(
"type"=>"textfield",
"heading"=>__("Training Process: Icon Title7", "revature"),
"param_name"=>"logo_title_7",
"description"=>__("Training Process: Icon Title7", "revature")
),
array(
"type"=>"textfield",
"heading"=>__("Training Process: Icon Sub Title7", "revature"),
"param_name"=>"logo_subtitle_7",
"description"=>__("Training Process: Icon Sub Title7", "revature")
),
)
));
...
array(
    "type"=>"textfield",
    "heading"=>__("Fancybox ID", "revature"),
    "param_name"=>"logo_id",
    "description"=>__("Fancybox ID(Unique)", "revature")
),
array(
    "type"=>"attach_image",
    "heading"=>__("Background Image", "revature"),
...
array(
	...
	array(
    "type" => "attach_image",
    "heading" => __("Sample Fancybox Image", "revature"),
    "param_name" => "sample_fancybox_img",
    "description" => __("Sample Fancybox Image", "revature")
    ),
)
));
    ...
    vc_map(array(
		...
		array(
			...
			array(
                "type" => "textarea_html",
                "heading" => __("Fancybox Description", "revature"),
                "param_name" => "content",
                "description" => __("Description for Fancybox", "revature")
            ),
        array(
                "type"=>"attach_image",
            ...
            array(
                "type"=>"textfield",
                "heading"=>__("Training Spotlight Subheader Text", "revature"),
                "param_name"=>"link_txt",
                "description"=>__("Training Spotlight Subheader Text", "revature")
            ),
    ...
    vc_map(array(
        ...
        array(
              ...
              array(
					...
					array(
					"type"=>"textfield",
					"heading"=>__("Training Social Header text", "revature"),
					"param_name"=>"link_txt",
					"description"=>__("Training Social Header text", "revature")
					),
					array(
					"type"=>"textfield",
					"heading"=>__("Training Social Header url", "revature"),
					"param_name"=>"link_url",
					"description"=>__("Training Social Header url", "revature")
					),
        )
    ));
