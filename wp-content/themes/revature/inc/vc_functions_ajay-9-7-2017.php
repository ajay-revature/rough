...
<h3 class="curriculum-title"><a class="fancybox" href="#inline'.$a['logo_id'].'">'. $a['header_title'] .'</a></h3>
...
<div> <h2 style="margin: 0% 11%;color:#f26925 !important;" class="leadership-desc-header">'.$a['header_title'].'</h2>
<p style="width:100% !important;padding: 32px !important;" class="leadership-desc-content">'.$a['logo_desc'].'</p></div>
</div>
</div>
</div>        
</section>';
...
<div id="'.$a[location_id1].'">
  ...
  <div id="myCarousel23"  class="carousel slide" data-ride="carousel" data-wrap="true">
   
    <ol class="carousel-indicators">
      <li data-target="#myCarousel23" data-slide-to="0" class="active"></li>
      <li data-target="#myCarousel23" data-slide-to="1"></li>
      <li data-target="#myCarousel23" data-slide-to="2"></li>
       <li data-target="#myCarousel23" data-slide-to="3"></li>
        <li data-target="#myCarousel23" data-slide-to="4"></li>
    </ol>
...
<div id="'.$a[location_id3].'">
  ...
  <div id="myCarousel2" class="carousel slide" data-ride="carousel">
    ...
    <ol class="carousel-indicators">
      <li data-target="#myCarouse12" data-slide-to="0" class="active"></li>
      <li data-target="#myCarouse12" data-slide-to="1"></li>
      <li data-target="#myCarouse12" data-slide-to="2"></li>
      <li data-target="#myCarouse12" data-slide-to="3"></li>
      <li data-target="#myCarouse12" data-slide-to="4"></li>
    </ol>
...
function training_social_media_section_func($atts, $content=null){
    $a=shortcode_atts(array(
        ...
        'link_txt'=>'Link Text',
			...
			$ab= do_shortcode('[instagram-feed num=12 cols=3 headercolor=#333]');
...
<div class="col-lg-8 col-md-8 col-sm-8 no-padding"><section class="hwd-bgg"> 
            ...
            <p>'.$a['sub_title'].'</p>
                ...
                <div class="clear"></div>
                <div style="float:right;"class="col-lg-6 col-md-6 col-sm-7 col-xs-12 position_round_text_section_fourth align-right-section">
                ...
                <div class="col-lg-6 col-md-6 col-sm-9 col-xs-12 position_round_text_section_fifth align-right-section">
				  ...
				  <div class="clear"></div>
                <div style="float:right;"class="col-lg-6 col-md-6 col-sm-8 col-xs-12 position_round_text_section_seventh align-right-section">
...
<div class="col-lg-4 col-md-4 col-sm-4 code_life_faq_section">  
  ...
  <div style="text-align:left;margin-top:17px;" class="col-lg-12 col-xs-12 form-group"> <span class="grey-submit-btn"><input type="submit" value="SEARCH" style="color: rgb(255, 255, 255);"><i class="fa fa-angle-right" aria-hidden="true"></i></span></div>
</form>
</div>               
</div>
...
function witny_landing_header_func($atts, $content=null){
        ...
        <div class="row no-margin contact-hero-content">
			...
			<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 mobile-center-align">
				<img class="margin-top-100" src="'.wp_get_attachment_url($a['logo_1']).'">
