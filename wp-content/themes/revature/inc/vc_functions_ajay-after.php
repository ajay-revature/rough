...
function training_curriculum_spotlight_func($atts, $content=null){
    ...
    $returnHTML = '
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 no-padding">    
                ...
                <p class="spotlight_subheader"><a href="'.$a['link_url'].'">'.$a['link_txt'].'</a></p> 
                </div>                
               </div>
               </section>';
               return $returnHTML;
...
function training_social_media_section_func($atts, $content=null){
    ...
    $returnHTML = '<div class="col-lg-4 col-md-4 col-sm-4 no-padding ">    
                ...
                <h3 class="spotlight_header"><a href="'.$a['link_url'].'">'.$a['link_txt'].'</a></h3>      
                </div>';
               return $returnHTML;
}
...
array(
    ...
    vc_map(array(
        ...
        array(
			...
			array(
				"type"=>"textfield",
				"heading"=>__("Training Spotlight Subheader Url", "revature"),
				"param_name"=>"link_url",
				"description"=>__("Training Spotlight Subheader Url", "revature")
				),
        )
    ));
