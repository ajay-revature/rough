...
if($_POST["limit"]!="" && $_POST["start"]!="" && $_POST["page"]!="")
{
 ...
 $page=$_POST["page"];
 $args = "SELECT SQL_CALC_FOUND_ROWS   wp_posts.ID,wp_posts.post_title,wp_posts.post_content FROM wp_posts  LEFT JOIN wp_term_relationships ON (wp_posts.ID = wp_term_relationships.object_id) WHERE 1=1  AND ( 
