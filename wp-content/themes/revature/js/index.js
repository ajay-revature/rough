...
sr.reveal('.business-img.left', {origin:'left'});
sr.reveal('.business-img.right', {origin:'right'});
sr.reveal('.RevPro-Bootcamp-container.right', {origin:'right', distance:'30px'});
sr.reveal('.RevPro-Bootcamp-container.left', {origin:'left', distance:'30px'});
